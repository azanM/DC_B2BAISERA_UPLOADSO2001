...
namespace B2BAISERA.Models.EFServer
{
    public partial class CUSTOM_S02001_IS
    {
        ...
        {
            if (previousValue != null && previousValue.CUSTOM_S02001_IS.Contains(this))
            {
                previousValue.CUSTOM_S02001_IS.Remove(this);
            }
    
            if (CUSTOM_TRANSACTIONDATA != null)
            {
                if (!CUSTOM_TRANSACTIONDATA.CUSTOM_S02001_IS.Contains(this))
                {
                    CUSTOM_TRANSACTIONDATA.CUSTOM_S02001_IS.Add(this);
                }
