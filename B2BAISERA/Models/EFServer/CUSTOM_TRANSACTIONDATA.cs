...
namespace B2BAISERA.Models.EFServer
{
    public partial class CUSTOM_TRANSACTIONDATA
    {
        ...
        public virtual ICollection<CUSTOM_S02001_IS> CUSTOM_S02001_IS
        {
            get
            {
                if (_cUSTOM_S02001_IS == null)
                {
                    var newCollection = new FixupCollection<CUSTOM_S02001_IS>();
                    newCollection.CollectionChanged += FixupCUSTOM_S02001_IS;
                    _cUSTOM_S02001_IS = newCollection;
                }
                return _cUSTOM_S02001_IS;
            }
            set
            {
                if (!ReferenceEquals(_cUSTOM_S02001_IS, value))
                {
                    var previousValue = _cUSTOM_S02001_IS as FixupCollection<CUSTOM_S02001_IS>;
                    if (previousValue != null)
                    {
                        previousValue.CollectionChanged -= FixupCUSTOM_S02001_IS;
                    }
                    _cUSTOM_S02001_IS = value;
                    var newValue = value as FixupCollection<CUSTOM_S02001_IS>;
                    if (newValue != null)
                    {
                        newValue.CollectionChanged += FixupCUSTOM_S02001_IS;
                    }
                }
            }
        }
        private ICollection<CUSTOM_S02001_IS> _cUSTOM_S02001_IS;
    
        public virtual ICollection<CUSTOM_S02001_HS> CUSTOM_S02001_HS
        {
            get
            {
                if (_cUSTOM_S02001_HS == null)
                {
                    var newCollection = new FixupCollection<CUSTOM_S02001_HS>();
                    newCollection.CollectionChanged += FixupCUSTOM_S02001_HS;
                    _cUSTOM_S02001_HS = newCollection;
                }
                return _cUSTOM_S02001_HS;
            }
            set
            {
                if (!ReferenceEquals(_cUSTOM_S02001_HS, value))
                {
                    var previousValue = _cUSTOM_S02001_HS as FixupCollection<CUSTOM_S02001_HS>;
                    if (previousValue != null)
                    {
                        previousValue.CollectionChanged -= FixupCUSTOM_S02001_HS;
                    }
                    _cUSTOM_S02001_HS = value;
                    var newValue = value as FixupCollection<CUSTOM_S02001_HS>;
                    if (newValue != null)
                    {
                        newValue.CollectionChanged += FixupCUSTOM_S02001_HS;
                    }
                }
            }
        }
        private ICollection<CUSTOM_S02001_HS> _cUSTOM_S02001_HS;
        ...
        private void FixupCUSTOM_S02001_IS(object sender, NotifyCollectionChangedEventArgs e)
        {
            if (e.NewItems != null)
            {
                foreach (CUSTOM_S02001_IS item in e.NewItems)
                {
                    item.CUSTOM_TRANSACTIONDATA = this;
                }
            }
            ...
            if (e.OldItems != null)
            {
                foreach (CUSTOM_S02001_IS item in e.OldItems)
                {
                    if (ReferenceEquals(item.CUSTOM_TRANSACTIONDATA, this))
                    {
                        item.CUSTOM_TRANSACTIONDATA = null;
        ...
        private void FixupCUSTOM_S02001_HS(object sender, NotifyCollectionChangedEventArgs e)
        {
            if (e.NewItems != null)
            {
                foreach (CUSTOM_S02001_HS item in e.NewItems)
                {
                    item.CUSTOM_TRANSACTIONDATA = this;
                }
            }
            ...
            if (e.OldItems != null)
            {
                foreach (CUSTOM_S02001_HS item in e.OldItems)
                {
                    if (ReferenceEquals(item.CUSTOM_TRANSACTIONDATA, this))
                    {
                        item.CUSTOM_TRANSACTIONDATA = null;
