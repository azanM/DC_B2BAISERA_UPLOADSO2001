...
namespace B2BAISERA.Models.EFServer
{
    public partial class EProcEntities : ObjectContext
    {
        ...
        public ObjectSet<CUSTOM_S02001_IS> CUSTOM_S02001_IS
        {
            get { return _cUSTOM_S02001_IS  ?? (_cUSTOM_S02001_IS = CreateObjectSet<CUSTOM_S02001_IS>("CUSTOM_S02001_IS")); }
        }
        private ObjectSet<CUSTOM_S02001_IS> _cUSTOM_S02001_IS;
    
        public ObjectSet<CUSTOM_S02001_TEMP_IS> CUSTOM_S02001_TEMP_IS
        {
            get { return _cUSTOM_S02001_TEMP_IS  ?? (_cUSTOM_S02001_TEMP_IS = CreateObjectSet<CUSTOM_S02001_TEMP_IS>("CUSTOM_S02001_TEMP_IS")); }
        }
        private ObjectSet<CUSTOM_S02001_TEMP_IS> _cUSTOM_S02001_TEMP_IS;
    
        public ObjectSet<CUSTOM_S02001_TEMP_HS> CUSTOM_S02001_TEMP_HS
        {
            get { return _cUSTOM_S02001_TEMP_HS  ?? (_cUSTOM_S02001_TEMP_HS = CreateObjectSet<CUSTOM_S02001_TEMP_HS>("CUSTOM_S02001_TEMP_HS")); }
        }
        private ObjectSet<CUSTOM_S02001_TEMP_HS> _cUSTOM_S02001_TEMP_HS;
    
        public ObjectSet<CUSTOM_S02001_HS> CUSTOM_S02001_HS
        {
            get { return _cUSTOM_S02001_HS  ?? (_cUSTOM_S02001_HS = CreateObjectSet<CUSTOM_S02001_HS>("CUSTOM_S02001_HS")); }
        }
        private ObjectSet<CUSTOM_S02001_HS> _cUSTOM_S02001_HS;
        ...
        public ObjectResult<CUSTOM_S02001_TEMP_HS> sp_CreatePOSeraToAI_HS()
        {
            return base.ExecuteFunction<CUSTOM_S02001_TEMP_HS>("sp_CreatePOSeraToAI_HS");
        }
        public ObjectResult<CUSTOM_S02001_TEMP_IS> sp_CreatePOSeraToAI_IS()
        {
            return base.ExecuteFunction<CUSTOM_S02001_TEMP_IS>("sp_CreatePOSeraToAI_IS");
        }
